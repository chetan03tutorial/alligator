...
import static com.ps.fw.bdd.alligator.web.response.ServiceResponse.withResult;
...
import com.ps.fw.bdd.alligator.annotations.RestInvoker;
import com.ps.fw.bdd.alligator.annotations.handler.AnnotationHandler;
import com.ps.fw.bdd.alligator.http.BaseFeatures;
import com.ps.fw.bdd.alligator.http.HttpClientManager;
import com.ps.fw.bdd.alligator.http.UriResolver;
import com.ps.fw.bdd.alligator.lang.JoinPointHelper;
import com.ps.fw.bdd.alligator.lang.MethodDetails;
import com.ps.fw.bdd.alligator.lang.MethodParameter;
import com.ps.fw.bdd.alligator.util.InvalidFormatException;
...
import com.ps.fw.bdd.alligator.web.response.ServiceResponse;
...
public class RequestMapperHandler implements Advice {
	...
	@Around("@annotation(com.ps.fw.bdd.alligator.annotations.RestInvoker)")
